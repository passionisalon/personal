              ...
              <div class="d-flex">
                <div class="p-2 flex-fill" v-if="result.gender">
                    <div class="form-check">
                      <input type="radio" class="form-check-input" id="radio1" name="optradio" value="true" checked v-model="result.gender"/>남성
                      <label class="form-check-label" for="radio1"></label>
                  </div>
                </div>
                <div class="p-2 flex-fill">
                    <div class="form-check">
                      <input type="radio" class="form-check-input" id="radio2" name="optradio" value="false" checked v-model="result.gender"/>>여성
