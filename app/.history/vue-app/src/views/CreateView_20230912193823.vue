        ...
        <h1 class="display-1 text-center">사용자 등록</h1>
          <form>
            ...
            <div class="mb-3 mt-3">
              ...
              <input type="email" class="form-control" id="email" placeholder="이메일를 입력하세요." name="email" autocomplete="off" :class="{{ active : active.name }}" readonly v-model="result.email">
            </div>
            <div class="mb-3">
