        ...
        <h1 class="display-1 text-center">사용자 정보</h1>
          ...
          <div class="d-flex">
            <div class="p-2 flex-fill d-grid">
                <buttont type="button" class="btn btn-primary" @click="edit">수정</buttont>
            </div>
            <div class="p-2 flex-fill d-grid">
              <buttont type="button" class="btn btn-primary" @click="del">삭제</buttont>
            </div>
            <div class="p-2 flex-fill d-grid">
              <buttont type="button" class="btn btn-primary" @click="cancle">취소</buttont>
            </div>
          </div>
      </div>
</template>
