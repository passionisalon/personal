...
export default function SignUp() {
    ...
    const [userPassword, setUserEmail] = useState<string>('');
    const [userPasswordCheck, setUserEmail] = useState<string>('');
    const [userNickname, setUserEmail] = useState<string>('');
    const [userPhoneNumber, setUserEmail] = useState<string>('');
    const [userAddress, setUserEmail] = useState<string>('');
    const [userAddressDetail, setUserEmail] = useState<string>('');
